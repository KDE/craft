...
{self.package}
    ...
    Platform supported: {self.package.categoryInfo.platforms.check(CraftCore.compiler.platform)} ({self.package.categoryInfo.platforms})
    Compiler supported: {self.package.categoryInfo.compiler.check(CraftCore.compiler.compiler)} ({self.package.categoryInfo.compiler})
    Architecture supported: {self.package.categoryInfo.architecture.check(CraftCore.compiler.architecture)} ({self.package.categoryInfo.architecture})
