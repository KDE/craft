            ...
            for package in packageList:
                ...
                if not package in self.categories[category]:
                    ...
                    self.categories[category].append(
                        PackageObjectBase(category=category, subpackage=subpackage, package=package))
                ...
                for subPackage in subPackageList:
                    if not os.path.isdir(
                            os.path.join(directory, category, package, subPackage)) or subPackage in Portage.VCSDirs():
                        continue

                    if not subPackage in self.subpackages:
                        self.subpackages[subPackage] = []
                        self.categories[category].append(
                            PackageObjectBase(category=category, subpackage=package, package=subPackage))
