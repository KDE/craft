...
class subinfo( info.infoclass ):
    ...
    def setTargets( self ):
        ...
        for ver in [ '0.9.8k' , '0.9.8m' ,'1.0.0', '1.0.0a', '1.0.0b', '1.0.0c', '1.0.1c', '1.0.1e', '1.0.1f', '1.0.1g', '1.0.1m', '1.0.2a' ]:
        ...
        self.patchToApply[ '1.0.2a' ] = ('openssl-1.0.2a.diff', 1)
