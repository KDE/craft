...
class subinfo(info.infoclass):
    def setTargets( self ):
        ...
        for ver in [ '7.20.0', '7.28.1', '7.32.0', '7.46.0', '7.51.0' ]:
        ...
        self.patchToApply['7.51.0'] = [("curl-7.51.0-20161129.diff", 1)]
        ...
        self.targetDigests['7.51.0'] = 'f02a14bbe580d2a8cf3bf45a79d39eb595220ac7'

        self.shortDescription = "a free and easy-to-use client-side URL transfer library"
        self.defaultTarget = '7.51.0'
...
class PackageMSys(AutoToolsPackageBase):
    def __init__(self):
        ...
        self.subinfo.options.configure.defines = " --disable-tests --enable-static=no --with-winssl"
