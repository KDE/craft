...
class subinfo(info.infoclass):
    def setTargets( self ):
        ...
        self.targetDigests['1.19'] = '4997951ab058788de48b989013668eb3df1e6939'
        self.patchToApply['1.12'] = [('libgpg-error-r267-20101205.diff', 1),
                                     ('libgpg-error-cmake-1.12.diff', 1)]
        self.patchToApply['1.19'] = [('libgpg-error-r267-20101205.diff', 1),
                                     ('libgpg-error-cmake-1.19.diff', 1)]
