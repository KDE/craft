...
class Package( BinaryPackageBase ):
    ...
    def install( self ):
        ...
        shutil.move( os.path.join( self.imageDir(), "bin", "win_flex.exe" ) , os.path.join( self.imageDir(), "bin", "flex.exe" ) )
        shutil.move( os.path.join( self.imageDir(), "bin", "win_bison.exe" ) , os.path.join( self.imageDir(), "bin", "bison.exe" ) )
