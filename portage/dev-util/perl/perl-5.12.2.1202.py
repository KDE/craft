...
class subinfo(info.infoclass):
    def setTargets( self ):
        ...
        if platform.buildArchitecture() == 'x64':
           ...
           self.targetMergeSourcePath['5.12.2'] = "ActivePerl-5.12.2.1202-MSWin32-x64-291969\\perl"
        else:
           ...
           self.targetMergeSourcePath['5.12.2'] = "ActivePerl-5.12.2.1202-MSWin32-x86-291969\\perl"
