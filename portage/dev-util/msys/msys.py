...
class subinfo(info.infoclass):
    def setTargets( self ):
        ver = "20160719"
        # don't set an actual version  instead of base. Msys must be manually updated so doing a emerge update of msys wil break things.
        if compiler.isX86():
            ...
            self.targetDigests['base'] = (['a3255ebba5888c3b4de7a01b6febce9336c66128953f061f7d80e1d8c56582ca'], EmergeHash.HashAlgorithm.SHA256)
