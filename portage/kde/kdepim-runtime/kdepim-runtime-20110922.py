...
class subinfo( info.infoclass ):
    def setTargets( self ):
        self.svnTargets['gitHEAD'] = '[git]kde:kdepim-runtime|KDE/4.7|'
        ...
        self.patchToApply['4.7.0'] = [("kdepim-runtime-4.7.0-20110823.diff", 1), ("0001-Ignore-items-with-empty-remote-ids-here.patch", 1)]
