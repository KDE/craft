...
class subinfo(info.infoclass):
    def setTargets( self ):
        ...
        for ver in ['0', '1', '2', '3', '4', '5']:
            ...
            self.patchToApply[kd.kdeversion + ver] = [('gwenview-4.10.2-allow-compilation-with-jpeg9.patch', 1),
                                                      ('replace-usage-of-unportable-mkdtemp-with-KTempDir-update.patch', 1)]
