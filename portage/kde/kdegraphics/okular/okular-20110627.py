...
class subinfo( info.infoclass ):
    def setTargets( self ):
        self.svnTargets['gitHEAD'] = '[git]kde:okular|KDE/4.8|'
        for ver in ['0', '1', '2', '3', '4']:
            self.targets['4.8.' + ver] = "ftp://ftp.kde.org/pub/kde/stable/4.8." + ver + "/src/okular-4.8." + ver + ".tar.bz2"
            self.targetInstSrc['4.8.' + ver] = 'okular-4.8.' + ver
