...
class subinfo(info.infoclass):
    def setTargets( self ):
        self.svnTargets['svnHEAD'] = 'branches/KDE/4.9/kdesdk'
        for ver in ['0', '1', '2', '3', '4', '5']:
            self.targets['4.9.' + ver] = 'ftp://ftp.kde.org/pub/kde/stable/4.9.' + ver + '/src/kdesdk-4.9.' + ver + '.tar.xz'
            self.targetInstSrc['4.9.' + ver] = 'kdesdk-4.9.' + ver
