...
class Package( CMakePackageBase ):
    def __init__( self, **args ):
        ...
        self.subinfo.options.configure.args = ' -DPHONON_BUILD_PHONON4QT5=ON -DPHONON_BUILDSYSTEM_DIR=\"%s\" ' % (os.path.join(CraftStandardDirs.craftRoot(),'share','phonon','buildsystem').replace('\\','/'))
