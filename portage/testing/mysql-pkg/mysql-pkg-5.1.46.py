...
class Package(CMakePackageBase):
  ...
  def install( self ):    
    ...
    shutil.copy( os.path.join( self.sourceDir() , "COPYING" ) , os.path.join( self.sourceDir() , "share" , "licence" , "mysql" ,  "COPYING"  ) )
    shutil.copy( os.path.join( self.sourceDir() , "EXCEPTIONS-CLIENT" ) , os.path.join( self.sourceDir() , "share" , "licence" , "mysql" ,  "EXCEPTIONS-CLIENT"  ) )
