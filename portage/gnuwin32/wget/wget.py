...
class subinfo(info.infoclass):
    def setTargets( self ):
        self.targets[ "1.18" ] = "http://downloads.sourceforge.net/sourceforge/tumagcc/wget-1.18_curl-7.49.1_win32_win64.7z"
...
class Package(BinaryPackageBase):
    ...
    def install( self ):
        ...
        utils.copyFile(os.path.join(self.sourceDir(), "curl-ca-bundle.crt"), os.path.join(self.installDir(), "bin", "curl-ca-bundle.crt"))
        return True