...
class Package( CMakePackageBase ):
    def __init__( self, **args ):
        ...
        self.subinfo.options.configure.defines = ' -DPHONON_BUILD_PHONON4QT5=ON -DPHONON_BUILDSYSTEM_DIR=\"%s\" ' % (os.path.join(os.getenv('KDEROOT'),'share','phonon','buildsystem').replace('\\','/'))
