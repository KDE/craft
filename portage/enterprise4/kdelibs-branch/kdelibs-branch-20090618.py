...
class subinfo(info.infoclass):
    ...
    def setDependencies( self ):
        ...
        self.hardDependencies['win32libs-sources/aspell']  = 'default'
#        self.hardDependencies['win32libs-sources/enchant']  = 'default'
        self.hardDependencies['win32libs-sources/gettext']  = 'default'
        self.hardDependencies['win32libs-sources/giflib']  = 'default'
#        self.hardDependencies['win32libs-sources/gssapi']  = 'default'
#        self.hardDependencies['win32libs-sources/hspell']  = 'default'
        self.hardDependencies['win32libs-sources/jasper']  = 'default'
        self.hardDependencies['win32libs-sources/jpeg']  = 'default'
        self.hardDependencies['win32libs-sources/libbzip2']  = 'default'
        self.hardDependencies['win32libs-sources/libpng']  = 'default'
        self.hardDependencies['win32libs-sources/libxml2']  = 'default'
        self.hardDependencies['win32libs-sources/libxslt']  = 'default'
#        self.hardDependencies['win32libs-sources/openexr']  = 'default'
        self.hardDependencies['win32libs-sources/openssl']  = 'default'
        self.hardDependencies['win32libs-sources/pcre']  = 'default'
        self.hardDependencies['win32libs-sources/shared-mime-info']  = 'default'
        self.hardDependencies['win32libs-sources/zlib']  = 'default'
