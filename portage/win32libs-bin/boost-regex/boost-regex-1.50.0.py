...
class subinfo( info.infoclass ):
    def setTargets( self ):
        ...
        for version in [ '1.48.0', '1.50.0' ]:
            self.targets[ version ]          = self.getPackage( repoUrl, 'boost-regex', version )
            self.targetDigestUrls[ version ] = self.getPackage( repoUrl, 'boost-regex', version, '.tar.bz2.sha1' )
