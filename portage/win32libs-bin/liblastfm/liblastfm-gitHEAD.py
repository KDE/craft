...
class subinfo( info.infoclass ):
    def setTargets( self ):
        ...
        for version in [ 'gitHEAD' ]:
            ...
            self.targetDigestUrls[ version ] = self.getPackage( repoUrl, 'liblastfm', version , '.tar.bz2.sha1' )
    ...
    def setDependencies( self ):
        ...
        self.runtimeDependencies[ 'win32libs-bin/libsamplerate' ] = 'default'
        self.runtimeDependencies[ 'libs/qt' ] = 'default'
        self.runtimeDependencies[ 'win32libs-bin/libfftw' ] = 'default'
