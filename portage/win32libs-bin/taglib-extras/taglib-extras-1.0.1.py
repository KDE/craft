...
class subinfo( info.infoclass ):
    def setTargets( self ):
        ...
        for version in [ '1.0.1' ]:
            self.targets[ version ]          = self.getPackage( repoUrl, 'taglib-extras', version )
            self.targetDigestUrls[ version ] = self.getPackage( repoUrl, 'taglib-extras', version , '.tar.bz2.sha1' )
    ...
    def setDependencies( self ):
        ...
        self.runtimeDependencies[ 'win32libs-bin/taglib' ] = 'default'
