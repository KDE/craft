...
# based on revision gitd34b5f6ef429fdaee87c9b1f1b61997e7635c732
...
class subinfo( info.infoclass ):
    def setTargets( self ):
        ...
        for version in [ '1.7.0' ]:
            self.targets[ version ]          = self.getPackage( repoUrl, 'openexr', version )
            self.targetDigestUrls[ version ] = self.getPackage( repoUrl, 'openexr', version, '.tar.bz2.sha1' )
    ...
    def setDependencies( self ):
        ...
        self.runtimeDependencies[ 'win32libs-bin/ilmbase' ] = 'default'
