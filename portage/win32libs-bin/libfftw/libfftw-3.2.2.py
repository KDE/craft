...
class subinfo( info.infoclass ):
    def setTargets( self ):
        ...
        for version in [ '3.2.2' ]:
            self.targets[ version ]          = self.getPackage( repoUrl, 'libfftw', version )
            self.targetDigestUrls[ version ] = self.getPackage( repoUrl, 'libfftw', version , '.tar.bz2.sha1' )
