...
class subinfo( info.infoclass ):
    def setTargets( self ):
        ...
        for version in [ '0.1.7' ]:
            self.targets[ version ]          = self.getPackage( repoUrl, 'libsamplerate', version )
            self.targetDigestUrls[ version ] = self.getPackage( repoUrl, 'libsamplerate', version , '.tar.bz2.sha1' )
    ...
    def setDependencies( self ):
        ...
        self.runtimeDependencies[ 'win32libs-bin/libsndfile' ] = 'default'
