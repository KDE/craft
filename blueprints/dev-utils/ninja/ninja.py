...
class subinfo(info.infoclass):
    ...
    def setTargets(self):
        ...
        self.targetDigests['1.10.2'] = (['ce35865411f0490368a8fc383f29071de6690cbadc27704734978221f25e2bed'], CraftHash.HashAlgorithm.SHA256)
        self.targetDigests['1.11.1'] = (['31747ae633213f1eda3842686f83c2aa1412e0f5691d1c14dbbcc67fe7400cea'], CraftHash.HashAlgorithm.SHA256)
