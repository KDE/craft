...
class subinfo(info.infoclass):
    ...
    def setTargets(self):
        for ver, rev, rt in [("11.2.0", "4", "9")]:
            ...
            self.targets[
                f"{ver}-{rev}"
            ] = f"https://github.com/cristianadam/mingw-builds/releases/download/v{ver}-rev{rev}/x86_64-{ver}-release-posix-seh-rt_v{rt}-rev{rev}.7z"
        self.targetDigests["11.2.0-4"] = (
            ["01afee61056d30480c7758b043f667814b724181a21b1465da3e98d1551bfa4f"],
