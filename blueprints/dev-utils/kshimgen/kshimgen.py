...
class subinfo(info.infoclass):
    ...
    def setTargets(self):
        ...
        self.targetDigests["0.2.0"] = (
            ["b5f93d81d6937edb6608b87e0a87c9b7783aa7488c350683865beac3207d4312"],
            CraftHash.HashAlgorithm.SHA256,
        )
        self.targetDigests["0.3.0"] = (
            ["1d5fee6e0cef513cbdef755b1829af2fe78be96eb88fa53a68594bfac0be7b0a"],
            CraftHash.HashAlgorithm.SHA256,
        )
        self.targetDigests["0.4.0"] = (
            ["b59bea7b02ba2c37efbdba5706abe48f32fa3ca44b5a5f4e182ba8cdbadf0a32"],
            CraftHash.HashAlgorithm.SHA256,
        )
        self.targetDigests["0.4.1"] = (
            ["a8d89683a89bffc1320273e1150a687745621231e1392bef04e89186b3f6cad9"],
            CraftHash.HashAlgorithm.SHA256,
        )
        self.targetDigests["0.4.2"] = (
            ["ce3f203c6a682cc69e876f2c56e912aace30d9483f73d376441f356d4ea247f2"],
            CraftHash.HashAlgorithm.SHA256,
        )
        self.targetDigests["0.4.3"] = (
            ["ebc514f9a07995c93d4ab7e2c10003ad42c41199572691cb92a506d546c2d340"],
            CraftHash.HashAlgorithm.SHA256,
        )
        self.targetDigests["0.4.4"] = (
